...
namespace inspect_san.Migrations
{
    ...
    [Migration("20260824233932_RefTablesAddAutoIncrementId")]
    partial class RefTablesAddAutoIncrementId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("inspect_san.Models.Entities.Ecole", b =>
                {
                    b.HasOne("inspect_san.Models.Entities.Categorie", "Categorie")
                        ...
                        .HasPrincipalKey("CodeCategories")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
