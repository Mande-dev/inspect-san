...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("inspect_san.Models.Entities.Mission", b =>
                {
                    ...
                    b.Property<bool>("RapportClos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);

                    b.Property<DateTime?>("RapportClosLe")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("RapportClosPar")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");

                    b.Property<DateTime?>("RapportEquipeDeposeLe")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("RapportEquipeDeposePar")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");

                    b.Property<DateTime?>("RapportSecretariatDeposeLe")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("RapportSecretariatDeposePar")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
            ...
            modelBuilder.Entity("inspect_san.Models.Entities.SousProvince", b =>
                {
                    ...
                    b.ToTable("SousProvince", (string)null);
                });
            ...
            modelBuilder.Entity("inspect_san.Models.Entities.Ecole", b =>
                {
                    ...
                    b.HasOne("inspect_san.Models.Entities.SousProvince", "SousProvince")
                        .WithMany()
                        .HasForeignKey("SousDivision")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
